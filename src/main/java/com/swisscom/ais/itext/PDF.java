...
public class PDF {
     ...
     */
    private InputStream inputFilePath;

    /**
     * Save file path from output file
     */
    private OutputStream outputFilePath;
     ...
     */
    PDF(@Nonnull InputStream inputFilePath, @Nonnull OutputStream outputFilePath, String signName,  String signReason, String signLocation, String signContact, int certificationLevel) {
    ...
    public void createSignedPdf(@Nonnull byte[] externalSignature, int estimatedSize) throws Exception {
        ...
        // Save to file
        OutputStream outputStream = outputFilePath;
